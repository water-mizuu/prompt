...
import "package:prompt/src/io/ffi/unix/termios.dart";
import "package:prompt/src/io/ffi/unix/unistd.dart";

class TermLibUnix implements TermLib {
  TermLibUnix() : _isRaw = false {
  ...
  void enableRawMode() {
    _isRaw = true;
    TermIOS origTermIOS = _origTermIOSPointer.ref;

    Pointer<TermIOS> newTermIOSPointer = calloc<TermIOS>()
